...
<template>
  <div class="secvices-section mx-auto max-w-[1280px] my-[40px] ">
    <div class="services-container flex flex-row xl:justify-center items-center gap-[20px] overflow-x-scroll px-6">
        <div class="card-block text-start w-2/2 md:w-full bg-cover bg-[#f4f4f4] p-4 sm:px-6 sm:py-4 min-w-[200px] sm:min-w-[260px] min-h-[200px] sm:min-h-[240px] flex flex-col justify-between">
