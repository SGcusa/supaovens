...
<template>
  <div class="relative flex flex-col md:flex-row text-start items-center overflow-hidden my-8 md:my-20">
    <img class="object-cover max-h-[160px] md:max-h-[360px]" src="https://i.ibb.co/DP3yTJRC/desktop-image.png" alt=""
      width="100%" height="100%">
    <div class="md:absolute md:z-10 md:m-4">
      <h1
        class="md:w-1/2 lg:w-1/3 flex flex-col gap-[10px] pt-[20px] md:pt-0 px-[20px] text-[20px] md:text-[32px] uppercase leading-[100%]">
