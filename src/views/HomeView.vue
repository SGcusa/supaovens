...
<template>
  <section>
    ...
    <div class="flex flex-col justify-center items-center z-10 my-0 mx-auto md:pl-[200px]">
      <h1 class="max-w-[500px] py-12 text-balance px-[20px] text-[24px] md:text-[40px] text-center md:!text-left">We deliver nationwide,<br/> Get your pizza oven delivered to your door step</h1>
    </div>
  </section>
  ...
  <section>
    <div class="max-w-[1280px] mx-auto md:my-[60px] px-[20px]">
      ...
      <div class="flex flex-col lg:flex-row lg:gap-[60px] mt-[20px] md:mt-[80px]">
        ...
        <div class="lg:w-1/2 w-full flex flex-col gap-[20px] justify-start items-start">
          <div class="flex flex-col min-[480px]:flex-row text-start">
            <p class="uppercase font-semibold min-w-[100px] min-[480px]:min-w-[200px]">Oven Pipe:</p> 
            <span class="item-1">Designed for optimal airflow, our oven pipes ensure smoke is efficiently directed away, keeping your cooking experience clean and smooth.</span>
          </div>
          <div class="flex flex-col min-[480px]:flex-row text-start">
            <p class="uppercase font-semibold min-w-[100px] min-[480px]:min-w-[200px]">Color Blend/Oven Coat:</p>
            <span class="item-1"> Each oven features a high-quality color coat, offering both durability and a sleek finish that complements any outdoor space.</span> 
          </div>
          <div class="flex flex-col min-[480px]:flex-row text-start">
            <p class="uppercase font-semibold min-w-[100px] min-[480px]:min-w-[200px]">Inside Diameter:</p>
            <span class="item-1">Ranging from 0.8m to 2m, our ovens provide ample cooking space, catering to both personal use and larger gatherings.</span>
          </div>
          <div class="flex flex-col min-[480px]:flex-row text-start">
            <p class="uppercase font-semibold min-w-[100px] min-[480px]:min-w-[200px]">Brick Decoration:</p>
            <span class="item-1">Carefully crafted brick designs not only enhance the oven’s structural strength but also add a refined, timeless look to your setup.</span>
          </div>
          <div class="flex flex-row gap-[20px] w-full">
            <div class="first-button relative w-1/2 md:w-[180px] border-[1px] bg-black overflow-hidden flex flex-row justify-start items-center md:mt-8">
              <router-link to="/about" class="button-text text-center max-[767px]:text-[12px] leading-[140%] min-w-[100px] text-white w-full md:w-[180px] py-2 md:py-3 uppercase">
                Read More
              </router-link>
